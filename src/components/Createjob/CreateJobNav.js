  ...
  return (
    <div className='sticky bg-[#0b0e13] border-b border-[#6925416e] top-0 z-50 w-full backdrop-blue flex-none'>
        ...
        <div className='py-4 mx-4 lg:mx-0 lg:px-8'>
          <div className='relative flex items-center justify-between'>
            ...
            <div className='flex items-center'>
              ...
              <div><Link to="/home"><button className='hidden md:block mr-4 text-sm uppercase font-semibold  hover:text-[#58182d] duration-150'>HOME</button></Link></div>
              <ProfileBtn />
      ...
      {showMenu ? <div className='absolute z-40 w-full'>
        <div><Link to="/home"><button className='text-start bg-white/30 backdrop-blur-xl border-b border-gray-400 px-4 py-6 w-full text-sm uppercase font-semibold  hover:text-[#58182d] duration-150'>Home</button></Link></div>
